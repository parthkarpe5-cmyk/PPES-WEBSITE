      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            {/* Social Icons */}
            <div className="mt-6">
              <p className="mb-3 text-xs font-semibold uppercase tracking-wider text-[#C9A227]">
                Follow Us
              </p>
              <div className="flex items-center gap-2">
                {socialLinks.map((s) => (
                  <a
                    ...
                    aria-label={s.label}
                    title={s.label}
                    className={`flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 text-white transition-all ${s.color} hover:scale-105 hover:text-white`}
                  >
                    {s.icon}
                  </a>
                ))}
            ...
            <div className="flex flex-col gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center gap-3 rounded-lg bg-white/5 px-4 py-3 transition-all hover:bg-white/10"
                >
                  <span className="text-white/70 transition-colors group-hover:text-white">
                    {s.icon}
                  </span>
                  <span className="text-sm text-white/60 transition-colors group-hover:text-[#C9A227]">
                    {s.label}
                  </span>
                </a>
              ))}
