      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3">
              <div className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl ring-1 ring-white/10">
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/55">
              Prarambha Path Evening School — Empowering students in Savardhat through
              experiential learning, Gurukul values, and holistic growth.
            </p>
              ...
              <div className="flex items-center gap-2">
                {socialLinks.map((s) => (
                  <a
                    ...
                    aria-label={s.label}
                    title={s.label}
                    className={`flex h-9 w-9 items-center justify-center rounded-xl bg-white/8 text-white/70 transition-all duration-300 ${s.hoverBg} hover:text-white hover:scale-105 hover:shadow-lg`}
                  >
                    {s.icon}
                  </a>
                ))}
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/8 pt-8 md:flex-row">
          <p className="text-xs text-white/30">
            &copy; {new Date().getFullYear()} Prarambha Path Evening School. All rights reserved.
          </p>
