    ...
    return (
      <div className="h-screen bg-[#0A0F1C] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-saffron font-medium animate-pulse uppercase tracking-widest text-xs">Loading Classroom Chat...</p>
        </div>
      </div>
    );
  }
      ...
      <header className="bg-[#0A0F1C]/80 backdrop-blur-xl border-b border-white/5 p-4 flex items-center justify-between z-10">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-saffron/20 flex items-center justify-center text-saffron font-bold border border-saffron/20">
              {doubt.subject_id[0]}
            </div>
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-500 text-[10px] uppercase tracking-widest font-bold">STUDENT: {doubt.student_id}</span>
              </div>
            </div>
          </div>
        </div>
                    ...
                    {!isMe && (
                      <div className="flex items-center gap-2 mb-2">
                        <div className="w-5 h-5 rounded-lg bg-sky/20 flex items-center justify-center">
                          <User size={12} className="text-sky" />
                        </div>
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <form onSubmit={handleSendMessage} className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-[2.5rem] p-2 pl-6 pr-2 focus-within:border-saffron/50 focus-within:bg-white/[0.08] transition-all shadow-2xl">
            ...
            <button 
              ...
              className="bg-saffron text-white w-14 h-14 rounded-full flex items-center justify-center hover:scale-105 active:scale-95 transition-all disabled:opacity-30 disabled:grayscale shadow-lg shadow-saffron/20"
            >
              {sending ? <div className="w-6 h-6 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : <Send size={24} />}
            </button>
          </form>
          <p className="text-center text-[10px] text-slate-600 mt-4 uppercase tracking-[0.2em] font-bold">Faculty Portal • Secure Classroom Chat</p>
        </div>
      </footer>
        ...
        {selectedImage && (
          ...
          >
            ...
            <div className="absolute top-0 left-0 right-0 p-6 flex justify-between items-center bg-gradient-to-b from-black/50 to-transparent z-[110]">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-saffron/20 flex items-center justify-center text-saffron font-bold border border-saffron/20">
                  {doubt.subject_id[0]}
                </div>
                <div>
            ...
            <div className="absolute bottom-10 flex items-center gap-2 bg-black/40 backdrop-blur-2xl p-2 rounded-[2rem] border border-white/10 z-[110]">
              ...
              <button 
                ...
                className="px-6 py-2 bg-saffron text-white text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg shadow-saffron/20"
              >
                Reset
              </button>
            </div>
