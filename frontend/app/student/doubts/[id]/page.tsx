          ...
          <div className="hidden md:flex gap-2">
            {doubt.status === 'open' && (
              <>
                ...
                <button onClick={() => handleStatusChange('closed')} className="px-4 py-2 bg-white/5 hover:bg-white/10 text-slate-400 rounded-xl text-[10px] font-black uppercase tracking-widest border border-white/10 transition-all">
                  Close
                </button>
              </>
            )}
